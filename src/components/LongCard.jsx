...
function LongCard({ title, children }) {
  return (
    <div className="mx-4 my-4  hover:bg-black-dark-200 border-whiten rounded-md bg-black-dark-400 p-2 shadow-lg sm:mx-auto sm:max-w-full md:max-w-full lg:max-w-full">
