...
const Footer = () => {
  return (
    <section id="contactus">
      <footer class="lg:grid lg:grid-cols-5">
        <div class="relative block h-40 lg:col-span-2 lg:h-full">
          <img
            src={process.env.REACT_APP_FIREBASE_FOOTER}
            alt=""
          ...
          <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
              ...
              <ul class="mt-8 space-y-1 text-sm text-gray-700">
                <li>Working days: 09:00 AM - 5:00 PM</li>
                ...
                <ul class="mt-6 space-y-4 text-sm">
                  <li>
                    <a
                      target="_blank"
                      rel="noreferrer"
                      href="https://smk24-6f0bf.web.app/"
          ...
          <div class="mt-12 border-t border-gray-100 pt-12 ">
            <div class="sm:flex sm:items-center sm:justify-between">
              ...
              <p class="mt-8 text-xs text-gray-500 sm:mt-0">
                &copy; 2024. TradeTact. All rights reserved. | Made with ❤️ in
                India
              </p>
            </div>
          </div>
