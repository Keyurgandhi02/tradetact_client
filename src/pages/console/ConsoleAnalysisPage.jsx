      ...
      {fetchedData.length > 0 && (
        <>
          <div className="mt-1 px-3 grid grid-cols-1 gap-2 md:grid-cols-12 md:mt-6 2xl:mt-7.5 2xl:gap-4.5">
            <div className="col-span-12 md:col-span-9 rounded-sm border-[0.6px] border-gray-500 bg-transparent px-3 py-5 sm:px-5.5">
            ...
            <div className="col-span-12 md:col-span-3 rounded-sm border-[0.6px] border-gray-500 bg-transparent px-3 py-5 sm:px-5.5">
          ...
          <div className="mt-1 px-3 grid grid-cols-1 gap-2 md:grid-cols-12 md:mt-6 2xl:mt-7.5 2xl:gap-4.5">
            <div className="col-span-12 md:col-span-12 rounded-sm border-[0.6px] border-gray-500 bg-transparent px-3 py-5 sm:px-5.5">
              <CardTitle title="Monthly Trade Analysis" />
          ...
          <div className="mt-1 px-3 grid grid-cols-1 gap-2 md:grid-cols-12 md:mt-6 2xl:mt-7.5 2xl:gap-4.5 mb-5">
            <div className="col-span-12 md:col-span-12 rounded-sm border-[0.6px] border-gray-500 bg-transparent px-3 py-5 sm:px-5.5">
              <CardTitle title="Accounts Trade Analysis" />
              <div className="h-120 overflow-y-auto no-scrollbar">
...
export default ConsoleAnalysisPage;
